...
#     cmd = f"CUDA_LAUNCH_BLOCKING=1 OMP_NUM_THREADS=4 CUDA_VISIBLE_DEVICES={gpu} python train.py -s MipNeRF360/{scene} -m {output_dir}/{scene} --eval -i images_{factor} --port {6109+int(gpu)}"
#     print(cmd)
#     if not dry_run:
#         os.system(cmd)
